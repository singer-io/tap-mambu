...
def test_installments_accounts_processor():
    from singer.catalog import Catalog
    catalog = Catalog.load(f"{FIXTURES_PATH}/processor_catalog.json")
    client_mock = MagicMock()

    from tap_mambu.tap_mambu_refactor.tap_processors.installments_processor import InstallmentsProcessor
    processor = InstallmentsProcessor(catalog=catalog,
