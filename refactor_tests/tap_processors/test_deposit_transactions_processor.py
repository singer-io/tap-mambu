...
def test_clients_processor():
    ...
    from tap_mambu.tap_mambu_refactor.tap_processors.deposit_transactions_processor import DepositTransactionsProcessor
    processor = DepositTransactionsProcessor(catalog=catalog,
                                             stream_name="deposit_transactions",
                                             client=client_mock,
                                             config=config_json,
