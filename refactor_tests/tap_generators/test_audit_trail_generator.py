...
@mock.patch("tap_mambu.tap_mambu_refactor.tap_generators.audit_trail_generator.utils")
...
@mock.patch("tap_mambu.tap_mambu_refactor.tap_generators.audit_trail_generator.get_bookmark")
@mock.patch("tap_mambu.tap_mambu_refactor.tap_generators.audit_trail_generator.utils")
...
def test_generator_iterator_flow():
    ...
    from tap_mambu.tap_mambu_refactor.tap_generators.audit_trail_generator import AuditTrailGenerator
