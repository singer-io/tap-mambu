...
class TestTransformJson(unittest.TestCase):
    ...
    def test_transform_json_handles_dictionary_custom_fields(self):
        # `_` fields are stripped from the record and flattened into custom_fields
        expected = [{'id': '1',
                     'custom_fields': [{'field_set_id': '_custom_1', 'id': 'id', 'value': '1'}]}]
    ...
    def test_transform_json_handles_list_custom_fields(self):
        ...
        expected = [{'id': '1',
                     'custom_fields': [
                         {'field_set_id': '_custom_1', 'id': 'id', 'value': '1'},
